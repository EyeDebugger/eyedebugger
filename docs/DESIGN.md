...
- netcoredbg eval limits and macOS arm64 stability → SharpDbg as the alternative (ADR 0017); e2e
  ...
  (arm64) and Windows (x64), and with SharpDbg alone on Intel Macs and Windows on Arm, where
  netcoredbg has no build; Python on all 6.
