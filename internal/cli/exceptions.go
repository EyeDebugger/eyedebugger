...
Code); an exception that would end the program always stops it, even with none. An adapter
without such a filter is UNSUPPORTED_BY_ADAPTER (exit 4), naming the filters it has.
